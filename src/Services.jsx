        ...
        <div className='w-full flex items-center gap-30 justify-center'>
          <div className='relative'>
            <div className='flex text-white gap-2 items-center absolute -top-[25px]'>
              <div className='rounded-full bg-[#7c8e67]/70   w-[50px] h-[50px] flex items-center justify-center'>01</div>
              <div className='bg-[#7c8e67]/70 rounded-2xl  px-2 py-1'>Custom Birthday Cake Service</div>
            </div>
