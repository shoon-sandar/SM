  ...
  return (
    <div>
      ...
      <div className='w-full p-8 flex justify-between gap-2 ' >
        ...
        <div className='w-[400px] h-[350px] bg-black/10 rounded-[45px] transition-transform duration-100 hover:scale-x-110'>
          ...
          <button className='ml-20 mt-5 text-center  w-[200px] h-[40px] border-2 border-rod px-6 py-1 rounded-full bg-rod/20 hover:bg-amber-500'>View Collection</button>
